...
export const CommonZh: Resources['translation'] = {
  ...
  header_publish: '发布',
  header_publish_app: '发布应用',
  header_publish_success: '应用发布成功',
  header_publish_failed: '应用发布失败，请稍后重试',
  header_publish_confirm: '确定要发布该应用吗？',
  ...
  app_delete_confirm: '你确定要删除该应用吗？',
  app_delete_yes: '是',
  app_delete_no: '否',
  app_update_success: '更新成功',
  baseinfo_app_name: '应用名称',
  baseinfo_app_icon: '应用图标',
  baseinfo_app_describe: '应用描述',
