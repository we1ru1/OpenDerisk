...
function ConfigurableForm({
  ...
  params: Array<ConfigurableParams> | null;
    ...
    <div className="space-y-4">
      {params?.map((param: ConfigurableParams) => (
        <Form.Item
          ...
          valuePropName={
            param.param_type.toLowerCase() === "bool" ||
            param.param_type.toLowerCase() === "boolean"
              ? "checked"
              : "value"
          }
          ...
          rules={
            param.required
              ? [
                  {
                    required: true,
                    message: `Please input ${param.label || param.param_name}`,
                  },
                ]
              : []
          }
