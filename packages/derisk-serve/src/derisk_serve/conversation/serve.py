...
from derisk.core import StorageInterface
...
class Serve(BaseServe):
    ...
    Message DERISK conversation history and provide API for other components to access.
    ...
    def on_init(self):
        ...
        """
        # Load DB Model
        from derisk.storage.chat_history.chat_history_db import (  # noqa: F401
    ...
    def before_start(self):
        ...
        from derisk.storage.chat_history.storage_adapter import (
