...
class SimpleAssistantAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "Tom",
            category="agent",
            key="derisk_agent_expand_simple_assistant_agent_profile_name",
        ),
        role=DynConfig(
            "AI Assistant",
            category="agent",
            key="derisk_agent_expand_simple_assistant_agent_profile_role",
        ),
        goal=DynConfig(
            "Understand user questions and give professional answer",
            category="agent",
            key="derisk_agent_expand_simple_assistant_agent_profile_goal",
        ),
        constraints=DynConfig(
            ...
            category="agent",
            key="derisk_agent_expand_simple_assistant_agent_profile_constraints",
        ),
        desc=DynConfig(
