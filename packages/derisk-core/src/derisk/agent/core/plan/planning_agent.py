...
#             "planner",
#             category="agent",
#             key="derisk_agent_planning_agent_profile_name",
#         ),
#         role=DynConfig(
#             "Planning Expert",
#             category="agent",
#             key="derisk_agent_planning_agent_profile_role",
#         ),
#         goal=DynConfig(
...
#             category="agent",
#             key="derisk_agent_planning_agent_profile_goal",
#         ),
#         expand_prompt=DynConfig(
#             "### 你可以安排的代理如下:\n {{ agents }}",
#             category="agent",
#             key="derisk_agent_planning_agent_profile_expand_prompt",
#         ),
...
#             None,  # noqa: E501
#             category="agent",
#             key="derisk_agent_planning_agent_profile_examples",
#         ),
#     )
#     language: str = "zh"
