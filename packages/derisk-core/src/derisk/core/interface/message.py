...
class ModelMessage(BaseModel):
    """Type of message that interaction between derisk-server and llm-server."""
...
class StorageConversation(OnceConversation, StorageItem):
    ...
    def clear(self) -> None:
        ...
        from derisk_serve.agent.db import GptsConversationsDao, GptsMessagesDao
