...
from derisk.core.awel import DAGVar
from derisk.core.awel.flow import ResourceCategory, register_resource
...
class DefaultEmbeddingFactory(EmbeddingFactory):
    ...
    def _load_model(self) -> Embeddings:
        from derisk.model.adapter.base import get_embedding_adapter
