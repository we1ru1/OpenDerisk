...
from derisk._private.pydantic import EXTRA_FORBID, BaseModel, ConfigDict, Field
from derisk.core import EmbeddingModelMetadata, Embeddings
...
class HuggingFaceEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from derisk.rag.embedding import HuggingFaceEmbeddings
...
class HuggingFaceInstructEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from derisk.rag.embeddings import HuggingFaceInstructEmbeddings
...
class HuggingFaceBgeEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from derisk.rag.embeddings import HuggingFaceBgeEmbeddings
...
class OpenAPIEmbeddings(BaseModel, Embeddings):
    ...
    Examples:
        ...
        Using DERISK APIServer's embedding API:
        To use the DERISK APIServer's embedding API, you should deploy DERISK according
        to the `Cluster Deploy
        <https://docs.derisk.site/docs/installation/model_service/cluster>`_.

        A simple example:
        1. Deploy Model Cluster with following command:
        .. code-block:: bash

            derisk start controller --port 8000

        2. Deploy Embedding Model Worker with following command:
        .. code-block:: bash

            derisk start worker --model_name text2vec \
        ...
        .. code-block:: bash
            ...
            derisk start apiserver --controller_addr http://127.0.0.1:8000 \
