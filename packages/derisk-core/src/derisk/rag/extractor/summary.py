...
below. \nBased on the previous reasoning_engine, please summarize the final conclusion in
...
class SummaryExtractor(Extractor):
    ...
    async def _aextract(self, chunks: List[Chunk]) -> str:
        ...
        from derisk.util.prompt_util import PromptHelper
    ...
    async def _llm_run_tasks(
        ...
        for chunk_text in chunk_texts:
            from derisk.core import ModelMessage
