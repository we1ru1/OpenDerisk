...
from derisk.core.interface.operators.message_operator import (
    BaseConversationOperator,
    BufferedConversationMapperOperator,
    TokenBufferedConversationMapperOperator,
)
from derisk.core.interface.operators.prompt_operator import HistoryPromptBuilderOperator
from derisk.model.operators import LLMOperator, StreamingLLMOperator
...
class BaseHOLLMOperator(
    ...
    def _build_conversation_composer_dag(self) -> DAG:
        ...
        with DAG(
            "derisk_awel_app_chat_history_prompt_composer",
...
_PARAMETER_LLM_CLIENT = Parameter.build_from(
    ...
    description=_(
        ...
        " the default client deployed by DERISK."
    ),
)
